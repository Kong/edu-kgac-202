...
export KONG_PROXY_HOSTNAME=instance.autolab.strigo.io
...
export KONG_ADMIN_API_HOSTNAME=instance.autolab.strigo.io
...
export KONG_MANAGER_HOSTNAME=instance.autolab.strigo.io
...
export KONG_PORTAL_GUI_HOST=instance.autolab.strigo.io
...
export KONG_PORTAL_API_HOSTNAME=instance.autolab.strigo.io
...
export KEYCLOAK_HOSTNAME=instance.autolab.strigo.io
...
export PROMETHEUS_HOSTNAME=instance.autolab.strigo.io
...
export PROMETHEUS_PORT=30006
export PROMETHEUS_HOSTNAME=instance.autolab.strigo.io
export PROMETHEUS_URI=instance.autolab.strigo.io:${PROMETHEUS_PORT}
export PROMETHEUS_URL="http://${PROMETHEUS_URI}"
export GRAFANA_PORT=30005
export GRAFANA_HOSTNAME=instance.autolab.strigo.io
export GRAFANA_URI=instance.autolab.strigo.io:${GRAFANA_PORT}
