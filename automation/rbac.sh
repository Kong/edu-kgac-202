...
sed -i "s/admin_gui_url:/admin_gui_url: $KONG_MANAGER_URL/g" ./helm/cp-values-rbac.yaml
sed -i "s/admin_api_url:/admin_api_url: $KONG_ADMIN_API_URL/g" ./helm/cp-values-rbac.yaml
sed -i "s/proxy_url:/proxy_url: $KONG_PROXY_URL/g" ./helm/cp-values-rbac.yaml
sed -i "s/portal_api_url:/portal_api_url: $KONG_PORTAL_API_URL/g" ./helm/cp-values-rbac.yaml
