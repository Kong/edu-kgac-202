...
./edu-kgac-201/exercises/troubleshooting/kiclogs.sh
./edu-kgac-201/exercises/troubleshooting/dplogs.sh
...
kubectl apply -f ~/edu-kgac-201/base/httpbin-ingress.yaml
http -h get kongcluster:30000/httpbin Kong-Debug:1

# Task: Use Granular Tracing to Log Details
kubectl apply -f ~/edu-kgac-201/exercises/vitals/httpbin-vitals.yaml
cat ~/edu-kgac-201/base/dp-values.yaml | grep tracing
...
cd ~/edu-kgac-201/exercises/troubleshooting
